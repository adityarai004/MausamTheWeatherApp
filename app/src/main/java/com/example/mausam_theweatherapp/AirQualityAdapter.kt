...
class AirQualityAdapter(val context : Context,val pollutantArrayList: ArrayList<PollutantViewModel>):RecyclerView.Adapter<AirQualityAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(holder.pollutantTV.text == "Quality Index"){
            ...
            holder.quantityTV.text = (quality).toString()
        }
    }
}